...
from Main_InternalResistance import TestRunIntenalResistance
from Main_Discharge import TestRunDischarge
from Main_OCVEstimate import TestRunOCVEstimate
