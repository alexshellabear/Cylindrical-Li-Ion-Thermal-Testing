...
class TemperatureClass:
    ...
    def AddData(self, data):
        self.TimeStamp.append(time.time()) # Add timestamp
    ...
    def ReachedSetPoint(self):
        if float(self.Thermo_Ave[-1]) > self.setpoint:
            self.status = "Cool"
            return True
        else:
            if self.status == "Cool":
    ...
    def WriteLine(self,FileObj):
        print(str(self.TimeStamp),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.status),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.Thermo_Ave),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.CJ_Ave),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.CJ_1),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.Thermo_1),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.CJ_2),file=FileObj,end="")
        print(",",file=FileObj,end="")
        print(str(self.Thermo_2),file=FileObj,end="")
        print("\n",file=FileObj,end="")
    ...
    def __init__(self,CBAExecutableFileLocation,CurrentDirectory,MaxTemperature):
        ...
        try:
            ...
            if TempString == "Starting": 
                print("Successfully started specific heat test... printing file to "+CurrentDirectory+FileName)
